...
export type SourceInfo = {
    /**
     * URL for the source GeoTIFF. `url`, `blob`, and `file` are mutually exclusive.
     */
    ...
    /**
     * File for the source GeoTIFF. `url`, `blob`, and `file` are mutually exclusive.
     */
    file?: string | undefined;
    /**
     * Blob containing the source GeoTIFF. `url`, `blob`, and `file` are mutually exclusive.
     */
    blob?: Blob | undefined;
    /**
